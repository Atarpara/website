...
This is the Cake website. It's a static site generated by [Wyam](http://wyam.io) which is hosted on Microsoft Azure. Wyam is a static content toolkit and can be used to generate static web sites, produce documentation, create ebooks, and much more.
